...
CREATE TABLE `vacinas` (
    ...
    `user_id` VARCHAR(191) NOT NULL,
    `notificacoes_enviadas` VARCHAR(191) NOT NULL DEFAULT '',
    `proxima_aplicacao` VARCHAR(191) NULL,

    INDEX `vacinas_user_id_fkey`(`user_id`),
...
CREATE TABLE `agendamentos` (
    ...
    `horario_agendamento` VARCHAR(191) NOT NULL,
    `user_id` VARCHAR(191) NOT NULL,
    `notificacoes_enviadas` VARCHAR(191) NOT NULL DEFAULT '',

    INDEX `agendamento_pet_id_fkey`(`pet_id`),
    INDEX `agendamento_user_id_fkeyge`(`user_id`),
    INDEX `agendamento_id_horario_fkey`(`id_horario`),
    INDEX `agendamento_id_empresa_fkey`(`id_empresa`),
    INDEX `agendamento_id_servico_fket`(`id_servico`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `horarios` (
    ...
    `id_empresa` VARCHAR(191) NOT NULL,
    `data_servico` VARCHAR(191) NOT NULL,
...
CREATE TABLE `expo_token` (
    ...
    UNIQUE INDEX `expo_token_user_id_key`(`user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
