...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'user' | 'category' | 'product' | 'order' | 'item' | 'pet' | 'curiosidade' | 'vacina' | 'exame' | 'publicacoes' | 'agendamentos' | 'servicos' | 'horarios' | 'empresa' | 'expoToken'
  ...
  interface HorariosFieldRefs {
    ...
    readonly id_empresa: FieldRef<"Horarios", 'String'>
  ...
  export type HorariosWhereInput = {
    ...
    id_empresa?: StringFilter<"Horarios"> | string
  ...
  export type HorariosScalarWhereWithAggregatesInput = {
    ...
    id_empresa?: StringWithAggregatesFilter<"Horarios"> | string
